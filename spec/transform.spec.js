...
describe('Transformation test', () => {
  ...
  it('should produce an empty message if transformation returns undefined', () => transformPersonFromOih.process(messages.newMessageWithBody({}))
    .then((result) => {
  ...
  it('should produce an empty message if transformation returns undefined', () => transformPersonToOih.process(messages.newMessageWithBody({}))
    .then((result) => {
      expect(result).to.be.undefined;
    }));
});
